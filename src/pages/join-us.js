			...
			<NavbarPaddingContainer>
				...
				<DescriptionFont>
					...
					<ul>
						...
						<ul>
							<li>
								Research <TinyFont>(for conducting space-related studies)</TinyFont>
							</li>
							<li>
								Competitions <TinyFont>(for participating in space case/policy competitions)</TinyFont>
							</li>
						</ul>
					</ul>
					<br />
				...
				<DescriptionFont>
					Members are required to participate in at least one project team and at least one management team.
					Membership lasts for the entire academic year. <br />
					<br />
					...
					<ul>
						...
						<li>
							attend on campus recruitment/ access to our job portal for internships and employment in the
							space industry (both local and overseas)
						</li>
					...
					<br />
					<br />
					We also strongly encourage our members to suggest and pioneer new initiatives that can help our club
					or community in any way.
					<br />
					<br />
					<br />
				</DescriptionFont>
