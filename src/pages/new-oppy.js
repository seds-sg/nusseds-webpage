...
const RoverPage = ({ data }) => (
  <Layout>
    <NavbarPaddingContainer>
      ...
      <DescriptionFont>
        New Opportunity is the flagship engineering project of NUS SEDS. The aim
        is to design and build a Remotely Operated Vehicle (ROV) that can
        ...
        warehouse management, disaster search and rescue and explosive ordnance
        disposal.
        <br />
        <br />
        The Rover Team plans to participate in the University Rover Challenge
        (URC) from November 2019 (registration) to May 2020 (competition). This
        is an annual competition held by The Mars Society at the Mars Desert
        Research Station in Utah, USA, where teams and their rovers are tasked
        with the completion of 4 mission requirements:
        <br />
        <br />
        <ul>
          <li>
            A Science Mission to investigate a site for the presence of current
            or past life.
          </li>
          <li>
          ...
          <li>
            An Autonomous Traversal Mission to autonomously travel to a site and
            locate a marker.
          </li>
        </ul>
      ...
      <DescriptionFont>
        ...
        industry-standard features for planetary exploration vehicles. The rover
        features a rocker-bogie suspension akin to that on the Curiosity rover,
        as well as independently powered wheels employing Ackermann-steering. It
        also incorporates many exciting independently-designed features such as
        a mast camera, Bluetooth-controlled robot arm, and Wi-Fi-enabled
        remote-control through a custom-made app.
      </DescriptionFont>
      <SectionHeaderWrapper headerText="FUTURE PLANS" />
      <DescriptionFont>
        The team has shortlisted over 30 highly talented individuals to work on
        the challenge rover for URC, called New Opportunity. Development of the
        vehicle is in full swing with strong collaboration between the subsystem
        teams. At this point, most subsystems have passed the evaluation stage,
        and designs are being finalized. The actual construction, testing, and
        implementation of the rover is contingent on further funding.
        <br />
        <br />
        Team members come from a diverse set of majors and years of study with a
        common passion for space exploration. The team promotes a culture of
        ...
        team members up to speed with regard to their technical skills, as well
        as to ensure project continuity.
      </DescriptionFont>
