	...
	<Layout>
		<NavbarPaddingContainer>
			...
			<DescriptionFont>
				...
				(registration) to May 2020 (competition). This is an annual competition held by The Mars Society at the
				Mars Desert Research Station in Utah, USA, where teams and their rovers are tasked with the completion
				of 4 mission requirements:
				<br />
				<br />
				<ul>
					<li>A Science Mission to investigate a site for the presence of current or past life.</li>
					<li>
						A Delivery Mission to deliver a variety of objects to mock astronauts in the field across rugged
						terrain.
					</li>
					<li>
						An Equipment Servicing Mission to perform dextrous operations on a mock lander using a robotic
						arm.
					</li>
			...
			<DescriptionFont>
				...
				construction. It took a small, dedicated workforce just 2 months and S$500 to complete, and incorporates
				many industry-standard features for planetary exploration vehicles. The rover features a rocker-bogie
				suspension akin to that on the Curiosity rover, as well as independently powered wheels employing
				Ackermann-steering. It also incorporates many exciting independently-designed features such as a mast
				camera, Bluetooth-controlled robot arm, and Wi-Fi-enabled remote-control through a custom-made app.
			</DescriptionFont>
			...
			<DescriptionFont>
				...
				called New Opportunity. Development of the vehicle is in full swing with strong collaboration between
				the subsystem teams. At this point, most subsystems have passed the evaluation stage, and designs are
				being finalized. The actual construction, testing, and implementation of the rover is contingent on
				further funding.
				<br />
				<br />
				...
				workshops. For instance, the team conducted a boot camp covering Robot Operating System, CAD modelling,
				fabricating techniques and the use of micro-controllers in electrical systems, all key elements in
			...
			<ImageWrapper>
				...
				/>
				<StyledAvatar name="Harsh Goel" description="Project Team Lead" data={data} imageName="harsh_goel" />
				<StyledAvatar
					name="Asyraf Abbas"
