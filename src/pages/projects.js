  ...
  return (
    <Layout>
      <NavbarPaddingContainer>
        ...
        <ImageWrapper>
          <StyledImageWithTitle description="New Opportunity" data={data} imageName="new_oppy" onClick={() => window.location = "/new-oppy"} />
          <StyledImageWithTitle description="DARPA SubT Challenge" minHeight="283px" data={data} imageName="darpa_subt" onClick={() => window.location = "/darpa-subt"} />
        </ImageWrapper>
